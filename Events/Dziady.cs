...
namespace EventManager.Events
{
    public class Dziady : Event, IEventHandlerTeamRespawn
    {
        ...
        public override void EventStart(RoundStartEvent ev)
        {
            ...
            Door gate_a = PluginHandler.Shared.Server.Map.GetDoors().Find(x => x.Name == "GATE_A");
            gate_a.Open = true;
            gate_a.Locked = true;
        ...
        public void OnTeamRespawn(TeamRespawnEvent ev)
        {
            ...
            ev.PlayerList.ForEach(zombie =>
            {
                ...
                zombie.Teleport(PluginHandler.Shared.Server.Map.GetSpawnPoints(RoleType.CHAOS_INSURGENCY)[rand.Next(0, 3)]);
            });
